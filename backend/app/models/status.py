...
class Status(Base):
    ...
    # Explicit audience for privacy="selected": JSON list of user ids.
    ...
    viewers = relationship(
        "StatusViewer", back_populates="status", cascade="all, delete-orphan"
    )

    __table_args__ = (Index("ix_status_user_created", "user_id", "created_at"),)
